...
layui.define(["layer"], function (exports) {
    let okLayer = {
		...
		open2: function (title, content, width, height, successFunction, endFunction) {
		    layer.open({
		        title: title,resize: false,id:1,
		        type: 1,
		        //maxmin: true,
		...
		open3: function (title, content, width, height, successFunction, endFunction) {
		    layer.open({
		        title: title,resize: false,id:1,
		        type: 1,
		        maxmin: false,
